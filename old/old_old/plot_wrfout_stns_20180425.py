...
var = 'TMAX'
(tmx_mx_obs, yy_tmx_mx_obs) = get_seasonal_stats_ghcnd(data_all, dts_all, \
                                                  stns, var, 'max')
(tmx_avg, yy_tmx_avg_obs) = get_seasonal_stats_ghcnd(data_all, dts_all, \
                                            stns, var, 'avg')
var = 'TMIN'
...
var = 'PREC'
pickle_file = pickle_dir + '/pcp_tot.pickle'
(pcp_tot, years) = get_seasonal_stats(data_all, dts_unique, models, stns, \
                                      stns, var, 'tot', pickle_file, 1)
#(pcp_max, years) = get_seasonal_stats(data_all, dts_unique, models, \
#                                      stns, var, 'max')
