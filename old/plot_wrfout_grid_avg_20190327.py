...
#            t1 = rundir + '/test.nc'
#            syscom = ncocom + ' ' + ' '.join(scsplit[0:1730]) + ' ' + t1
#            print syscom
#            iret = os.system(syscom)
#            if iret != 0:
#                print 'problem running nco! iret = ', iret
...
#                syscom = ncocom + ' -O ' + str(scsplit[n]) + ' ' + t1
#                print syscom
#                iret = os.system(syscom)
#                if iret != 0:
#                    print 'problem running nco! iret = ', iret
...
#            sys.exit()
            ...
            if nfiles > 1000:
                ...
                fp1 = rundir + '/fp1.nc'
                fp2 = rundir + '/fp2.nc'
                syscom1 = ' '.join(scsplit[0:1000])
                syscom2 = scsplit[1000:nfiles]
                syscom2.insert(0,ncocom)
                syscom2 = ' '.join(syscom2)

                syscom1 = syscom1 + ' ' + fp1
                syscom2 = syscom2 + ' ' + fp2

                print 'syscom1 = ', syscom1

                iret1 = os.system(syscom1)
                if iret1 != 0:
                    print 'problem running nco! iret1 = ', iret1
                    sys.exit()
                    
                print ''
                print 'syscom2 = ', syscom2                
                iret2 = os.system(syscom2)                
                if iret2 != 0:
                    print 'problem running nco! iret2 = ', iret2
                    sys.exit()


                syscom3 = ncocom + ' ' + fp1 + ' ' + fp2 + ' ' + file_plot
                iret3 = os.system(syscom3)
                if iret3 != 0:
                    print 'problem running nco! iret3 = ', iret3
                    sys.exit()
...
#            print 'plotdat.shape = ', plotdat.shape
